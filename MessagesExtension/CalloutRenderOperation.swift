...
class CalloutRenderOperation: Operation {
    ...
    fileprivate lazy var attributes:[NSAttributedString.Key:AnyObject] = {
        let font=UIFont.init(name: "AmericanTypewriter-Bold", size: self.fontSize)
        let style=NSMutableParagraphStyle()
        style.alignment=NSTextAlignment.center
        style.lineBreakMode=NSLineBreakMode.byWordWrapping
        let at:[NSAttributedString.Key:AnyObject]=[.font:font!,
                                                  .foregroundColor:#colorLiteral(red: 1, green: 1, blue: 1, alpha: 1),
                                                  .strokeColor:#colorLiteral(red: 0, green: 0, blue: 0, alpha: 1),
                                                  .strokeWidth:-4.0 as AnyObject,
    ...
    override func main() {
        ...
        if ratio>1{
            ...
            let font=self.attributes[NSAttributedString.Key.font] as! UIFont
            ...
            self.attributes[NSAttributedString.Key.font]=newFont
        ...
        blankAttributes[.foregroundColor]=UIColor.clear
        blankAttributes[.strokeColor]=UIColor.clear
        blankAttributes[.strokeWidth]=nil
